package com.diskschedulingalgos.look;
...
public final class Look extends DiskSchedulingAlgorithm {

    public Look(int[] requestQueue) {
    ...
    public void algorithm() {
        ...
        if (!taskDone) {
            ...
            Collections.reverse(requestArrList);
